...
public class EZUtils {
    private static String picRootPath = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM).getPath()+"/Camera";
    public static void initRootPath(Context context)
    {
        if(context == null)
            return;
        picRootPath  = picRootPath+"/moorgen";
    }

	public static String generateVedioFilePath(String rootPath, String cameraId, String deviceSerial) {
		// 生成文件路径,文件格式为mnt/sdcard/VideoGo/20120901/20120901141138540_test
		if (TextUtils.isEmpty(rootPath)) {
            rootPath = picRootPath;
		}
    ...
    public static void saveCapturePictrue(String filePath, String thumbnailFilePath, Bitmap bitmap) throws Exception {
